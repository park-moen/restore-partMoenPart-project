...
<module external.linked.project.id=":reactNativeNMap" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../example/android" external.system.id="GRADLE" external.system.module.group="example" external.system.module.version="unspecified" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":reactNativeNMap" />
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_8">
    ...
    <orderEntry type="library" name="Gradle: com.squareup.okhttp3:okhttp:3.12.8@jar" level="project" />
    ...
    <orderEntry type="library" name="Gradle: com.naver.maps:map-sdk:3.10.2@aar" level="project" />
    <orderEntry type="library" name="Gradle: androidx.appcompat:appcompat:1.0.2@aar" level="project" />
    <orderEntry type="library" name="Gradle: com.naver.maps:geometry:1.2.0@aar" level="project" />
    ...
    <orderEntry type="library" name="Gradle: com.getkeepsafe.relinker:relinker:1.4.1@aar" level="project" />
  </component>
</module>