...
export default function InputPwd({ data, textPasswordChange, updateChkSecure }) {
    return (
        <>
            {/* 패스워드 입력란 */}
            <Text style={styles.text_footer}>패스워드</Text>
            <View style={styles.action}>
                ...
                <TextInput style={styles.textInput}
                    ...
                    onChangeText={(pw) => textPasswordChange(pw)} //입력값이 password state에 반영됨.
                />
