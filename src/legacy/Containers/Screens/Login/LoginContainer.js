...
import LoginComponent from '@legacy_pLogin/LoginComponent';

import { Login } from '@/src/legacy/lib/api/TokenActivity';
import { getLectureSchedule } from '@/src/legacy/lib/api/Lecture';
